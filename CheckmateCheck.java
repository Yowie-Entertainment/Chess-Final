...
public class CheckmateCheck {
    ...
    public CheckmateCheck(Board b, LinkedList<Piece> wPieces, 
      ...
      // Updates the board with the new actions on the board
    ...
    //check if the king can evade away from check mate
